    ...
    if (signupForm) {
        signupForm.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                alert(navigator.language?.startsWith("fr") ? "L'inscription a échoué. Merci de réessayer." : navigator.language?.startsWith("de") ? "Registrierung fehlgeschlagen. Bitte versuche es erneut." : "Signup failed. Please try again.");
            }
        });
    } else {
